...
\usepackage{tabularx, ragged2e} % Para formatear tablas
\spanishdecimal{.}
...
\input{./Chapters/portada}                                                      % Portada
\pagestyle{fancy}                                                               % Estilo de página
\fancyhead{}                                                                    % Encabezado de la página
\input{./Chapters/diseno}                                                       % Diseño de hoja
\input{./Chapters/formato}                                                      % Formato de tesis
...
\input{./Chapters/ApendiceB}
\input{./Chapters/ApendiceC}
