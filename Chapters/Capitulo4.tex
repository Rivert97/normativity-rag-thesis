...
\textit{Pdfplumber}. Ambos métodos cumplieron con la finalidad de generar una
...
ventajas, por lo que se seleccionó como el método de extracción de información
...
logrando reducir a 2.5 minutos al procesar 48 páginas en paralelo, pudiendo
...
con una bandera de configuración. Sin embargo, una ventaja de
...
21 documentos diferentes, con un total de 1,832 preguntas y respuestas,
...
innecesario o contradictorio, pues muchos hacen referencia
...
que las preguntas contengan las palabras clave tal cual están redactadas
...
del Rector General?. Esto podría generar preguntas más fáciles de responder y
...
de que no siempre el fragmento relevante real está dentro de los tres
...
tiende a cometer ligeras imprecisiones en las respuestas, como omitir
...
de Azure del tipo \textit{Standard B2pts v2 (2vcpus, 1GiB memory)}, con
...
\textit{docker-compose.yml} en el que se indica el contenedor a usar, el puerto a
...
Una desventaja de esta estructura es que la
...
Figura \ref{fig:login_page} se muestra el formulario de inicio de sesión.
...
donde estos datos sean incluidos sin que la repetición constante
...
el sistema mostró la capacidad de responder preguntas indirectas como
...
ya que si la pregunta es demasiado simple, el sistema no puede encontrar
