...
es decir, quey haya al menos una línea en blanco entre ellos.
...
mostrada a continuación, que contiene la pregunta, y los documentos
relevantes en formato JSON con todos sus datos.
Una vez generada la instrucción, se le proporciona
...
identificados como relevantes por el extractor de información y el modelador
de lenguaje. Se emplearán tres métricas: \textit{precision@k}, \textit{recall@k} y
