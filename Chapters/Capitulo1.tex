...
itensificó con la introducción de ChatGPT en 2022 \cite{openai_introducing_2022},
...
de los LLMs llevó a la creación del Transformer Generativamente Preentrenado
...
escenciales que se requiere entender para realizar el proyecto, así como
las herramientas de las que se hará uso. En el capítulo tres se presenta
la metodología a seguir para complir con el objetivo de generar poner en
