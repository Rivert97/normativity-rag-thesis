...
top-3 y top-5 documentos relevantes respectivamente. Se debe considerar que la precisión
...
\textit{Dell Precission 7920 Tower}, que es de 16GB+2GB+2BG, y se determina que el modelo
...
\begin{table}[!ht]
    ...
    \end{tabular}
    \caption{Configuraciones de entranamiento de los modelos. Taza de aprendizaje (LR),
...
evaluación de extracción de documentos, obteniendo el \textit{precision},
...
la máquina virtual, mientras que la \textit{Dell Precission 7920 Tower}
...
\begin{figure}
    ...
    \caption{Diagrama de contenedores en servidor \textit{Dell Precission Tower}.}
...
documentos que el RAG detectó como relevantes, pero que el modelo de
...
\begin{figure}
    ...
    \caption{Ejemplo de artículos de referencia mostrado por el asistente.
        Se muestran además otros documentos posiblemente relacionados.}
...
cual no se encuentra ningún documento relevante, el modelo responde
